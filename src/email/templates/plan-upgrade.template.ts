export const planUpgradeTemplate = `
            ...
            <tr>
              <td align="center" style="padding-bottom:25px;">
                <p style="margin:0; font-size:16px; color:#4b5563; line-height:1.6;">
                  Your plan has been successfully upgraded. You now have access to premium features to create smarter, stronger resumes.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:20px; background:#f9fafb; border-radius:8px; border:1px solid #e5e7eb;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <tr>
                    <td style="padding-top:10px; font-size:14px; color:#6b7280;">Amount Paid</td>
                    <td align="right" style="padding-top:10px; font-size:14px; font-weight:bold; color:#111827;">
                      {{AMOUNT}}
                    </td>
                  </tr>
                  <tr>
                    <td style="padding-top:10px; font-size:14px; color:#6b7280;">Billing Date</td>
                    <td align="right" style="padding-top:10px; font-size:14px; font-weight:bold; color:#111827;">
                      {{DATE}}
                    </td>
                  </tr>
